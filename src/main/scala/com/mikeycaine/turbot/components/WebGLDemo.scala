...
@react class WebGLDemo extends Component{
  def elemId: String = "webGLElement"

  case class Props(name: String, number: Long)
  ...
  override def render(): ReactElement = {
    div(className := "webgltitle")(
      p(className := "webgltitle")("Still works: " + props.name + " and the number is " + props.number),
      div(id := elemId)
    )
  }
  ...
  private def createAScene(): Scene = new Scene()
